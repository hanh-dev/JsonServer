  ...
  return (
    <React.Fragment>
      ...
      <div className="container mb-5 mt-5">
        <h4 className="txtdeepshadow text-center text-danger mb-5">
          Chi tiết Sản phẩm
        </h4>
        <div className="row">
          ...
          <div className="col-sm-4">
            <div className="widget">
              <h3 className="widget-title txtdeepshadow text-danger text-center">
                Baker Alley's Cake
              </h3>
                ...
                <div className="beta-sales beta-lists">
                  <div className="media beta-sales-item">
                    <a className="pull-left" href="product.html">
                      <img
                        src="assets/dest/images/products/sales/1.png"
                        alt=""
                      />
                    </a>
                  ...
                  <div className="media beta-sales-item">
                    <a className="pull-left" href="product.html">
                      <img
                        src="assets/dest/images/products/sales/2.png"
                        alt=""
                      />
                    </a>
